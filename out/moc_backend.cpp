...
template <> constexpr inline auto Backend::qt_create_metaobjectdata<qt_meta_tag_ZN7BackendE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Method 'addNumbers'
        QtMocHelpers::MethodData<int(int, int)>(1, 2, QMC::AccessPublic, QMetaType::Int, {{
...
void Backend::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: { int _r = _t->addNumbers((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2])));
